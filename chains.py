...
3. You should definetly recommend atleast one or more search queries to research information and improve your answer.""",
        ),
...
if __name__ == "__main__":
    human_message = HumanMessage(
        content="Write about companies that work on Autonomous driving domain,"
